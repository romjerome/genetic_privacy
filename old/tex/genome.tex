...
User contributed genealogy is looked down upon by professional genealogists as error-prone. From the computer scientist's perspective, however, more data is almost always better; sophisticated algorithms can help filter out noise and correct inconsistent information. Besides, the accuracy requirements of genealogical data for our attack are much lower than for traditional applications of such data.
...
{\em Note about the fact that the cheapest way to do disease screening will soon be genotyping.}
...
In the United States, the {\em Newborn Screening Saves Lives Act} was signed into law in 2008, allocating  federal funds for states to collect DNA samples for disease screening and follow-up purposes. 
...
{\bf Acknowledgement.}
I would like to especially thank Sriram Sankararaman, who helped me navigate a field of scientific inquiry in which I had virtually no previous knowledge, and my mentors Vitaly Shmatikov and Dan Boneh for many useful discussions and ideas. I could not have done this research without them. Many, many other people offered help, encouragement and pointers; in no particular order: Elizabeth Joh, Alex Khomenko, Anshul Kundaje, Serafim Batzoglou, Hua Tang, Seth Schoen, Lee Tien, Peter Eckersley, Joseph Bonneau, Elie Bursztein, Paul Ohm, Cynthia Dwork, Aaron Johnson, Paul Syverson, Peter Djeu.
