...
Broadly, there are two steps in the construction of genealogies of deceased persons: digitization of vital records, and analysis of the digitized data. There are many organizations involved in the first phase, such as the volunteer-driven FreeBMD in the UK \cite{freebmd} and the LDS church which operates (primarily) in the United States. The LDS church maintains the International Genealogical Index, which has data on 250 million names \cite{familysearch}.
